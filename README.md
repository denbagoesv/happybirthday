...
- The user must enter a **6-digit secret passcode** (`130905`) to unlock the surprise.
...
|---|---|
| Correct passcode | `const correctCode = "130905";` (line 80) |
...
**What it does:**
- Shows a **giant "HAPPY BIRTHDAY ADELUUU"** heading with glowing gradient text.
...
| Field | Description |
|---|---|
| `name` | Birthday person's name (e.g., `"Adel"`) |
...
3. Enter passcode `130905` to begin the experience.
